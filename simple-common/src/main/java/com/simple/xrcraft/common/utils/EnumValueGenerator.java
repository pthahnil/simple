package com.simple.xrcraft.common.utils;
 ...
 * @author pthahnil
 * @date 2020/4/8 17:51
 * @link https://www.niceideas.ch/roller2/badtrash/entry/java-create-enum-instances-dynamically
 */
public class EnumValueGenerator {
	...
	private static ConstructorAccessor getConstructorAccessor(Class<?> enumClass,
		...
		return reflectionFactory
				.newConstructorAccessor(enumClass.getDeclaredConstructor(parameterTypes));
	}
	...
	private static Object makeEnum(Class<?> enumClass, String value, int ordinal,
		...
		return enumClass
				.cast(getConstructorAccessor(enumClass, additionalTypes).newInstance(parms));
	}
